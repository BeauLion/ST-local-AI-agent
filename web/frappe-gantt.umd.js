(function (y, x) {
  ...
  const y = "year",
    ...
    d = {
      parse_duration(n) {
        ...
        if (e !== null) {
          if (e[2] === "y") return { duration: parseInt(e[1]), scale: "year" };
          if (e[2] === "m") return { duration: parseInt(e[1]), scale: "month" };
          if (e[2] === "d") return { duration: parseInt(e[1]), scale: "day" };
          if (e[2] === "h") return { duration: parseInt(e[1]), scale: "hour" };
          if (e[2] === "min")
      ...
      parse(n, t = "-", e = /[.:]/) {
        ...
        if (typeof n == "string") {
          let i, s;
          const r = n.split(" ");
          ((i = r[0].split(t).map((o) => parseInt(o, 10))),
            (s = r[1] && r[1].split(e)),
            (i[1] = i[1] ? i[1] - 1 : 0));
          let a = i;
          return (
            s &&
              s.length &&
              (s.length === 4 &&
                ((s[3] = "0." + s[3]), (s[3] = parseFloat(s[3]) * 1e3)),
              (a = a.concat(s))),
            new Date(...a)
          );
        }
      ...
      to_string(n, t = !1) {
        ...
        const e = this.get_date_values(n).map(
            (r, a) => (
              a === 1 && (r = r + 1),
              a === 6 ? v(r + "", 3, "0") : v(r + "", 2, "0")
            ),
      ...
      format(n, t = "YYYY-MM-DD HH:mm:ss.SSS", e = "en") {
        const i = new Intl.DateTimeFormat(e, { month: "long" }),
          s = new Intl.DateTimeFormat(e, { month: "short" }),
          r = i.format(n),
          a = r.charAt(0).toUpperCase() + r.slice(1),
          o = this.get_date_values(n).map((g) => v(g, 2, 0)),
          h = {
            YYYY: o[0],
            MM: v(+o[1] + 1, 2, 0),
            DD: o[2],
        ...
        return (
          Object.keys(h)
            .sort((g, c) => c.length - g.length)
            .forEach((g) => {
              l.includes(g) &&
                ((l = l.replaceAll(g, `$${_.length}`)), _.push(h[g]));
            }),
          _.forEach((g, c) => {
            l = l.replaceAll(`$${c}`, g);
          }),
      ...
      diff(n, t, e = "day") {
        let i, s, r, a, o, h, l;
        ((i = n - t + (t.getTimezoneOffset() - n.getTimezoneOffset()) * 6e4),
          (s = i / 1e3),
          (a = s / 60),
          (r = a / 60),
          (o = r / 24));
      ...
      today() {
        const n = this.get_date_values(new Date()).slice(0, 3);
        return new Date(...n);
      },
      now() {
        return new Date();
      ...
      start_of(n, t) {
        const e = { [y]: 6, [x]: 5, [M]: 4, [D]: 3, [Y]: 2, [T]: 1, [E]: 0 };
        function i(r) {
          const a = e[t];
          return e[r] <= a;
        }
  ...
  function f(n, t) {
    ...
    for (let i in t)
      i === "append_to"
        ? t.append_to.appendChild(e)
        : i === "innerHTML"
          ? (e.innerHTML = t.innerHTML)
          : i === "clipPath"
            ? e.setAttribute("clip-path", "url(#" + t[i] + ")")
  ...
  ((p.on = (n, t, e, i) => {
    ...
    (p.closest = (n, t) =>
      t ? (t.matches(n) ? t : p.closest(n, t.parentNode)) : null),
    (p.attr = (n, t, e) => {
  ...
  class q {
    ...
    calculate_path() {
      ...
      if (
        ...
        _ < 0 &&
          ((_ = 0), (o = this.gantt.options.padding / 2), (l = a ? -o : o));
        const g =
            this.to_task.$bar.getY() + this.to_task.$bar.getHeight() / 2 - l,
          c = this.to_task.$bar.getX() - this.gantt.options.padding;
        this.path = `
                M ${t} ${i}
                v ${_}
                a ${o} ${o} 0 0 1 ${-o} ${o}
  ...
  class C {
    ...
    prepare_values() {
      ((this.invalid = this.task.invalid),
        ...
        this.task.progress > 100 && (this.task.progress = 100));
    }
    prepare_helpers() {
    ...
    draw() {
      (this.draw_bar(),
        ...
        this.gantt.options.show_expected_progress &&
    ...
    draw_bar() {
      ((this.$bar = f("rect", {
        ...
        L(this.$bar, "width", 0, this.width),
        this.invalid && this.$bar.classList.add("bar-invalid"));
    }
    draw_expected_progress_bar() {
      this.invalid ||
        ((this.$expected_bar_progress = f("rect", {
          x: this.x,
          y: this.y,
    ...
    draw_progress_bar() {
      ...
      ((this.$date_highlight = i),
        this.gantt.$lower_header.prepend(this.$date_highlight),
        L(this.$bar_progress, "width", 0, this.progress_width));
    }
    calculate_progress_width() {
      const t = this.$bar.getWidth(),
        e = this.x + t,
        i =
      ...
      for (; o.length;)
        ((s += this.gantt.config.column_width),
          (o = this.gantt.get_ignored_region(this.x + s)));
    ...
    draw_thumbnail() {
      let t = 10,
        ...
        i,
        s;
      ((i = f("defs", { append_to: this.bar_group })),
        f("rect", {
        ...
        (s = f("clipPath", { id: "clip_" + this.task.id, append_to: i })),
        f("use", { href: "#rect_" + this.task.id, append_to: s }),
        f("image", {
          x: this.x + t,
          y: this.y + e,
          width: this.image_size,
    ...
    draw_resize_handles() {
      ...
      for (let i of this.handles)
        (p.on(i, "mouseenter", () => i.classList.add("active")),
          p.on(i, "mouseleave", () => i.classList.remove("active")));
    }
    bind() {
    ...
    setup_click_event() {
      ...
      (p.on(this.group, "mouseover", (i) => {
        this.gantt.trigger_event("hover", [this.task, i.screenX, i.screenY, i]);
      }),
        this.gantt.options.popup_on === "click" &&
          p.on(this.group, "mouseup", (i) => {
            const s = i.offsetX || i.layerX;
            if (this.$handle_progress) {
              const r = +this.$handle_progress.getAttribute("cx");
              if ((r > s - 1 && r < s + 1) || this.gantt.bar_being_dragged)
                return;
            }
      ...
      (p.on(this.group, "mouseenter", (i) => {
        ...
        p.on(this.group, "mouseleave", () => {
          ...
          (clearTimeout(e),
            this.gantt.options.popup_on === "hover" &&
              ((s = (i = this.gantt.popup) == null ? void 0 : i.hide) == null ||
                s.call(i)),
            this.gantt.$container
              .querySelector(`.highlight-${t}`)
              .classList.add("hide"));
      ...
      if (t) {
        if (
          !this.task.dependencies
            .map((a) => this.gantt.get_bar(a).$bar.getX())
            .reduce((a, o) => t >= o, t)
        )
          return;
        (this.update_attr(i, "x", t),
          (this.x = t),
          (this.$date_highlight.style.left = t + "px"));
      }
      (e > 0 &&
        (this.update_attr(i, "width", e),
        (this.$date_highlight.style.width = e + "px")),
    ...
    update_label_position_on_horizontal_scroll({ x: t, sx: e }) {
      const i = this.gantt.$container.querySelector(".gantt-container"),
        s = this.group.querySelector(".bar-label"),
        r = this.group.querySelector(".bar-img") || "",
        a = this.bar_group.querySelector(".img_mask") || "";
      let o = this.$bar.getX() + this.$bar.getWidth(),
        h = s.getX() + t,
        l = (r && r.getX() + t) || 0,
        _ = (r && r.getBBox().width + 7) || 7,
        g = h + s.getBBox().width + 7,
        c = e + i.clientWidth / 2;
      s.classList.contains("big") ||
        (((g < o && t > 0 && g < c) ||
          (h - _ > this.$bar.getX() && t < 0 && g > c)) &&
          (s.setAttribute("x", h),
          r && (r.setAttribute("x", l), a.setAttribute("x", l))));
    }
    date_changed() {
      let t = !1;
      const { new_start_date: e, new_end_date: i } =
    ...
    compute_start_end_date() {
      const t = this.$bar,
        e = t.getX() / this.gantt.config.column_width;
      let i = d.add(
        this.gantt.gantt_start,
    ...
    compute_expected_progress() {
      ((this.expected_progress =
        d.diff(d.today(), this.task._start, "hour") / this.gantt.config.step),
        (this.expected_progress =
    ...
    compute_x() {
      ...
      let r =
        (d.diff(e, i, this.gantt.config.unit) / this.gantt.config.step) * t;
      this.x = r;
    }
    compute_y() {
      this.y =
        ...
        (e++,
          !this.gantt.config.ignored_dates.find(
            ...
            (!this.gantt.config.ignored_function ||
              !this.gantt.config.ignored_function(i)) &&
            t++);
      ((this.task.actual_duration = t),
        (this.task.ignored_duration = e - t),
        (this.duration =
          d.convert_scales(e + "d", this.gantt.config.unit) /
          this.gantt.config.step),
        (this.actual_duration_raw =
          d.convert_scales(t + "d", this.gantt.config.unit) /
          this.gantt.config.step),
      ...
      let r = this.popup_func({
        ...
        add_action: (a, o) => {
          ...
          (typeof a == "function" && (a = a(i)),
            (h.innerHTML = a),
            (h.onclick = (l) => o(i, this.gantt, l)));
        },
      });
      r !== !1 &&
        (r && (this.parent.innerHTML = r),
        this.actions.innerHTML === ""
          ? this.actions.remove()
  ...
  function O(n, t, e) {
    let i = d.add(n, 6, "day"),
      s = i.getMonth() !== n.getMonth() ? "D MMM" : "D",
      r = !t || n.getMonth() !== t.getMonth() ? "D MMM" : "D";
  ...
  const b = [
      {
        ...
        lower_text: "HH",
        upper_text: (n, t, e) =>
          !t || n.getDate() !== t.getDate() ? d.format(n, "D MMMM", e) : "",
      ...
      },
      {
        ...
        lower_text: "HH",
        upper_text: (n, t, e) =>
          !t || n.getDate() !== t.getDate() ? d.format(n, "D MMM", e) : "",
      ...
      },
      {
        ...
        lower_text: "HH",
        upper_text: (n, t, e) =>
          !t || n.getDate() !== t.getDate()
            ? n.getMonth() !== n.getMonth()
              ? d.format(n, "D MMM", e)
              : d.format(n, "D", e)
            : "",
      ...
      },
      {
        ...
        step: "1d",
        lower_text: (n, t, e) =>
          !t || n.getDate() !== t.getDate() ? d.format(n, "D", e) : "",
        upper_text: (n, t, e) =>
          !t || n.getMonth() !== t.getMonth() ? d.format(n, "MMMM", e) : "",
    ...
    I = {
      ...
      padding: 18,
      popup: (n) => {
        (n.set_title(n.task.name),
          n.task.description
            ? n.set_subtitle(n.task.description)
            : n.set_subtitle(""));
        const t = d.format(n.task._start, "MMM D", n.chart.options.language),
          e = d.format(
  ...
  class S {
    ...
    setup_wrapper(t) {
      ...
      (e
        ...
        : (this.$svg = f("svg", { append_to: i, class: "gantt" })),
    ...
    setup_options(t) {
      ...
      for (let i in e) {
        ...
        s !== "auto" &&
          this.$container.style.setProperty("--gv-" + i, s + "px");
      }
      if (
        ((this.config = {
          ignored_dates: [],
        ...
        typeof this.options.ignore == "string" &&
          ...
          typeof i == "string" &&
            (i === "weekend"
              ? (this.config.ignored_function = (s) =>
                  s.getDay() == 6 || s.getDay() == 0)
              : this.config.ignored_dates.push(new Date(i + " ")));
        }
      } else this.config.ignored_function = this.options.ignore;
    }
    update_options(t) {
      (this.setup_options({ ...this.original_options, ...t }),
    ...
    setup_tasks(t) {
      ((this.tasks = t
        .map((e, i) => {
          if (!e.start)
            return (
              console.error(`task "${e.id}" doesn't have a start date`),
              !1
            );
          if (
            ((e._start = d.parse(e.start)),
            e.end === void 0 &&
              e.duration !== void 0 &&
              ((e.end = e._start),
              e.duration.split(" ").forEach((o) => {
            ...
            return (
              console.error(`task "${e.id}" doesn't have an end date`),
              !1
            );
          ...
          if (
            ((e._index = i),
            d
              .get_date_values(e._end)
              .slice(3)
              .every((a) => a === 0) && (e._end = d.add(e._end, 24, "hour")),
            typeof e.dependencies == "string" || !e.dependencies)
          ) {
            let a = [];
            (e.dependencies &&
              (a = e.dependencies
                .split(",")
                .map((o) => o.trim().replaceAll(" ", "_"))
                .filter((o) => o)),
              (e.dependencies = a));
          }
          return (
    ...
    update_task(t, e) {
      let i = this.tasks.find((r) => r.id === t),
        s = this.bars[i._index];
      (Object.assign(i, e), s.refresh());
    }
    change_view_mode(t = this.options.view_mode, e = !1) {
      typeof t == "string" &&
        (t = this.options.view_modes.find((r) => r.name === t));
      let i, s;
      (e &&
        ((i = this.$container.scrollLeft),
        (s = this.options.scroll_to),
        (this.options.scroll_to = null)),
        (this.options.view_mode = t.name),
        (this.config.view_mode = t),
        this.update_view_scale(t),
        this.setup_dates(e),
        this.render(),
        e && ((this.$container.scrollLeft = i), (this.options.scroll_to = s)),
    ...
    update_view_scale(t) {
      ...
      ((this.config.step = e),
        ...
        (this.config.column_width =
          this.options.column_width || t.column_width || 45),
    ...
    setup_gantt_dates(t) {
      let e, i;
      this.tasks.length || ((e = new Date()), (i = new Date()));
      for (let s of this.tasks)
        ((!e || s._start < e) && (e = s._start),
          (!i || s._end > i) && (i = s._end));
      if (
        ((e = d.start_of(e, this.config.unit)),
        (i = d.start_of(i, this.config.unit)),
        !t)
      )
        if (this.options.infinite_padding)
          ...
          typeof this.config.view_mode.padding == "string" &&
            (this.config.view_mode.padding = [
              this.config.view_mode.padding,
              this.config.view_mode.padding,
            ]);
          let [s, r] = this.config.view_mode.padding.map(d.parse_duration);
          ((this.gantt_start = d.add(e, -s.duration, s.scale)),
            (this.gantt_end = d.add(i, r.duration, r.scale)));
        }
    ...
    setup_date_values() {
      ...
      for (this.dates = [t]; t < this.gantt_end;)
        ((t = d.add(t, this.config.step, this.config.unit)),
          this.dates.push(t));
    }
    bind_events() {
    ...
    setup_layers() {
      ...
      for (let e of t)
        this.layers[e] = f("g", { class: e, append_to: this.$svg });
    ...
    make_grid_background() {
      const t = this.dates.length * this.config.column_width,
        e = Math.max(
          this.config.header_height +
      ...
      (f("rect", {
        ...
        p.attr(this.$svg, { height: e, width: "100%" }),
        (this.grid_height = e),
        this.options.container_height === "auto" &&
          (this.$container.style.height = e + "px"));
    }
    make_grid_rows() {
      const t = f("g", { append_to: this.layers.grid }),
        e = this.dates.length * this.config.column_width,
    ...
    make_side_header() {
      if (
        ...
        for (const i of this.options.view_modes) {
          ...
          ((s.value = i.name),
            ...
            i.name === this.config.view_mode.name && (s.selected = !0),
            t.appendChild(s));
        }
        (t.addEventListener(
          "change",
      ...
      if (this.options.today_button) {
        ...
        (t.classList.add("today-button"),
          (t.textContent = "Today"),
          (t.onclick = this.scroll_current.bind(this)),
          this.$side_header.prepend(t),
          (this.$today_button = t));
      }
    }
    make_grid_ticks() {
      ...
      let t = 0,
        ...
        i = this.grid_height - this.config.header_height,
        s = f("g", { class: "lines_layer", append_to: this.layers.grid }),
        r = this.config.header_height;
      const a = this.dates.length * this.config.column_width,
        o = this.options.bar_height + this.options.padding;
      ...
      if (this.options.lines !== "horizontal")
        for (let h of this.dates) {
          ...
          (this.config.view_mode.thick_line &&
            this.config.view_mode.thick_line(h) &&
            (l += " thick"),
            f("path", {
              d: `M ${t} ${e} v ${i}`,
              class: l,
        ...
        for (let e in this.options.holidays) {
          ...
          if (typeof i == "object") {
            ...
            if ((r && (s = r), this.options.holidays.name)) {
              ...
              i = (a) =>
                this.options.holidays[e]
                  .filter((o) => typeof o != "function")
                  .map((o) => {
                    if (o.name) {
                      let h = new Date(o.date + " ");
          ...
          for (
            let r = new Date(this.gantt_start);
            r <= this.gantt_end;
            ...
            if (
              !(
                ...
                (this.config.ignored_function &&
                  this.config.ignored_function(r))
              ) &&
              (i(r) || (s && s(r)))
            ) {
              const a =
                  (d.diff(r, this.gantt_start, this.config.unit) /
                    this.config.step) *
                  this.config.column_width,
                o = this.grid_height - this.config.header_height,
                h = d
                  .format(r, "YYYY-MM-DD", this.options.language)
                  .replace(" ", "_");
              if (t[r]) {
              ...
              f("rect", {
                ...
                width:
                  this.config.column_width /
                  d.convert_scales(this.config.view_mode.step, "day"),
                height: o,
    ...
    highlight_current() {
      ...
      const r =
        (d.diff(new Date(), this.gantt_start, this.config.unit) /
          this.config.step) *
        this.config.column_width;
    ...
    make_grid_highlights() {
      ...
      for (
        let i = new Date(this.gantt_start);
        i <= this.gantt_end;
        i.setDate(i.getDate() + 1)
      ) {
        if (
          !this.config.ignored_dates.find((r) => r.getTime() == i.getTime()) &&
    ...
    create_el({
      ...
      return (
        ...
        (l.style.left = t + "px"),
        r && (l.id = r),
        i && (l.style.width = i + "px"),
        s && (l.style.height = s + "px"),
        o && o.appendChild(l),
        l
      );
    }
    ...
    get_date_info(t, e) {
      ...
      let r = this.config.view_mode.upper_text,
        a = this.config.view_mode.lower_text;
      return (
        r
          ? typeof r == "string" &&
            (this.config.view_mode.upper_text = (o) =>
              d.format(o, r, this.options.language))
          : (this.config.view_mode.upper_text = () => ""),
        a
          ? typeof a == "string" &&
            (this.config.view_mode.lower_text = (o) =>
              d.format(o, a, this.options.language))
          : (this.config.view_mode.lower_text = () => ""),
        {
          date: t,
          formatted_date: k(
            d.format(t, this.config.date_format, this.options.language),
          ),
    ...
    map_arrows_on_bars() {
      for (let t of this.bars)
        t.arrows = this.arrows.filter(
          (e) =>
            e.from_task.task.id === t.task.id ||
            e.to_task.task.id === t.task.id,
        );
    }
    set_dimensions() {
      const { width: t } = this.$svg.getBoundingClientRect(),
        e = this.$svg.querySelector(".grid .grid-row")
    ...
    set_scroll_position(t) {
      ...
      const i =
        (d.diff(t, this.gantt_start, this.config.unit) / this.config.step) *
        this.config.column_width;
    ...
    get_closest_date() {
      ...
      let e = new Date(),
        i = this.$container.querySelector(
          ".date_" +
            k(d.format(e, this.config.date_format, this.options.language)),
        ),
        s = 0;
      for (; !i && s < this.config.step;)
        ((e = d.add(e, -1, this.config.unit)),
          (i = this.$container.querySelector(
            ".date_" +
              k(d.format(e, this.config.date_format, this.options.language)),
          )),
        ...
        ((e.onmouseenter = (r) => {
          s = setTimeout(() => {
            (i.classList.add("show"),
              (i.style.left = (r.offsetX || r.layerX) + "px"),
              (i.style.top = (r.offsetY || r.layerY) + "px"));
          }, 300);
        }),
          (e.onmouseleave = (r) => {
    ...
    get_start_end_positions() {
      ...
      let { x: t, width: e } = this.bars[0].group.getBBox(),
        i = t,
        s = t,
        r = t + e;
      return (
        Array.prototype.forEach.call(this.bars, function ({ group: a }, o) {
    ...
    bind_bar_events() {
      ...
      let l = 0;
      if (
        (p.on(this.$svg, "mousemove", ".bar-wrapper, .handle", (_) => {
          this.bar_being_dragged === !1 &&
            Math.abs((_.offsetX || _.layerX) - l) > 10 &&
            (this.bar_being_dragged = !0);
        }),
        p.on(this.$svg, "mousedown", ".bar-wrapper, .handle", (_, g) => {
          const c = p.closest(".bar-wrapper", g);
          (g.classList.contains("left")
            ? ((s = !0), g.classList.add("visible"))
            : g.classList.contains("right")
              ? ((r = !0), g.classList.add("visible"))
              : g.classList.contains("bar-wrapper") && (t = !0),
            this.popup && this.popup.hide(),
            (e = _.offsetX || _.layerX),
            _.offsetY || _.layerY,
            (a = c.getAttribute("data-id")));
          let u;
          (this.options.move_dependencies
            ? (u = [a, ...this.get_all_dependent_tasks(a)])
            : (u = [a]),
            (o = u.map(($) => this.get_bar($))),
            (this.bar_being_dragged = !1),
            (l = e),
            o.forEach(($) => {
              const m = $.$bar;
        ...
        p.on(this.$container, "mousewheel", (g) => {
          ...
          if (!_ && g.currentTarget.scrollLeft <= c) {
            ...
            ((_ = !0),
              ...
              this.render(),
              (g.currentTarget.scrollLeft =
                u + this.config.column_width * this.config.extend_by_units),
              setTimeout(() => (_ = !1), 300));
          }
          if (
            !_ &&
            g.currentTarget.scrollWidth -
              (g.currentTarget.scrollLeft + g.currentTarget.clientWidth) <=
              c
          ) {
            let u = g.currentTarget.scrollLeft;
            ((_ = !0),
      ...
      (p.on(this.$container, "scroll", (_) => {
        ...
        (i && (u = _.currentTarget.scrollLeft - i),
          (this.current_date = d.add(
            this.gantt_start,
            (_.currentTarget.scrollLeft / this.config.column_width) *
              this.config.step,
            this.config.unit,
          )));
        let $ = this.config.view_mode.upper_text(
          ...
          m = this.upperTexts.find((w) => w.textContent === $);
        ((this.current_date = d.add(
          this.gantt_start,
          ((_.currentTarget.scrollLeft + m.clientWidth) /
            this.config.column_width) *
            this.config.step,
          this.config.unit,
        )),
          ...
          m !== this.$current &&
            (this.$current && this.$current.classList.remove("current-upper"),
            m.classList.add("current-upper"),
            (this.$current = m)),
          (i = _.currentTarget.scrollLeft));
        let [H, B, j] = this.get_start_end_positions();
        (i > j + 100
          ? ((this.$adjust.innerHTML = "&larr;"),
            this.$adjust.classList.remove("hide"),
            (this.$adjust.onclick = () => {
              this.$container.scrollTo({ left: B, behavior: "smooth" });
            }))
          : i + _.currentTarget.offsetWidth < H - 100
            ? ((this.$adjust.innerHTML = "&rarr;"),
              this.$adjust.classList.remove("hide"),
              (this.$adjust.onclick = () => {
                this.$container.scrollTo({ left: H, behavior: "smooth" });
              }))
            : this.$adjust.classList.add("hide"),
          u &&
            ((g = c.map((w) => this.get_bar(w))),
            this.options.auto_move_label &&
              g.forEach((w) => {
        ...
        p.on(this.$svg, "mousemove", (_) => {
          ...
          o.forEach((c) => {
            const u = c.$bar;
            ((u.finaldx = this.get_snap_position(g, u.ox)),
              this.hide_popup(),
              s
                ? a === c.task.id
                  ...
                  : c.update_bar_position({ x: u.ox + u.finaldx })
                : r
                  ? a === c.task.id &&
                    c.update_bar_position({ width: u.owidth + u.finaldx })
                  : t &&
        ...
        document.addEventListener("mouseup", () => {
          ...
          ((t = !1),
            ...
            (c =
              (g =
                (_ = this.$container.querySelector(".visible")) == null
                  ? void 0
                  : _.classList) == null
                ? void 0
                : g.remove) == null || c.call(g, "visible"));
        }),
    ...
    bind_bar_progress() {
      ...
      p.on(this.$svg, "mousedown", ".handle.progress", (o, h) => {
        ((e = !0),
          (t = o.offsetX || o.layerX),
          (y_on_start = o.offsetY || o.layerY));
        ...
        ((i = this.get_bar(_)),
          ...
          (s.owidth = s.getWidth()),
          (s.min_dx = -s.owidth),
          (s.max_dx = r.getWidth() - s.getWidth()));
      });
      ...
      (p.on(this.$svg, "mousemove", (o) => {
        ...
        if (h > t) {
          let g = a.find(([c, u]) => h >= c && h < u);
          for (; g;) ((h = g[1]), (g = a.find(([c, u]) => h >= c && h < u)));
        } else {
          let g = a.find(([c, u]) => h > c && h <= u);
          for (; g;) ((h = g[0]), (g = a.find(([c, u]) => h > c && h <= u)));
        }
        let _ = h - t;
        (_ > s.max_dx && (_ = s.max_dx),
          _ < s.min_dx && (_ = s.min_dx),
          s.setAttribute("width", s.owidth + _),
          p.attr(i.$handle_progress, "cx", s.getEndX()),
          (s.finaldx = _));
      }),
    ...
    get_all_dependent_tasks(t) {
      ...
      for (; i.length;) {
        const s = i.reduce(
          (r, a) => ((r = r.concat(this.dependency_map[a])), r),
          [],
        );
    ...
    get_snap_position(t, e) {
      ...
      let a =
          t -
          r +
          (r < (this.config.column_width / i) * 2
            ? 0
            : this.config.column_width / i),
        o = e + a;
      const h = a > 0 ? 1 : -1;
      let l = this.get_ignored_region(o, h);
      for (; l.length;)
        ((o += this.config.column_width * h),
          (l = this.get_ignored_region(o, h)),
          l.length || (o -= this.config.column_width * h));
      return o - e;
    }
    get_ignored_region(t, e = 1) {
      return e === 1
        ? this.config.ignored_positions.filter(
    ...
    unselect_all() {
      (this.popup && this.popup.parent.classList.add("hide"),
        this.$container
    ...
    view_is(t) {
      return typeof t == "string"
        ? this.config.view_mode.name === t
        : Array.isArray(t)
          ? t.some(view_is)
          : this.config.view_mode.name === t.name;
    }
    get_task(t) {
    ...
    show_popup(t) {
      this.options.popup !== !1 &&
        (this.popup ||
          (this.popup = new F(this.$popup_wrapper, this.options.popup, this)),
        this.popup.show(t));
    }
    hide_popup() {
      this.popup && this.popup.hide();
    ...
    get_oldest_starting_date() {
      return this.tasks.length
        ? this.tasks.map((t) => t._start).reduce((t, e) => (e <= t ? e : t))
        : new Date();
    }
    clear() {
      var t, e, i, s, r, a, o, h, l, _;
      ((this.$svg.innerHTML = ""),
        (e = (t = this.$header) == null ? void 0 : t.remove) == null ||
          e.call(t),
        (s = (i = this.$side_header) == null ? void 0 : i.remove) == null ||
          s.call(i),
        (a = (r = this.$current_highlight) == null ? void 0 : r.remove) ==
          null || a.call(r),
        (h = (o = this.$extras) == null ? void 0 : o.remove) == null ||
          h.call(o),
        (_ = (l = this.popup) == null ? void 0 : l.hide) == null || _.call(l));
    }
  }
  S.VIEW_MODE = {
    HOUR: b[0],
